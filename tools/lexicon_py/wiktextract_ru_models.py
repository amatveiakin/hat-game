# Copy of https://github.com/tatuylonen/wiktextract/blob/7f1df12268270cbb8a8dc669791c8ed694198c5e/src/wiktextract/extractor/ru/models.py
...
class Translation(BaseModelWrap):
    ...
    lang: str = Field(description="Localized language name of the translation term")
    sense: str = Field(
        default="",
...
class WordEntry(BaseModelWrap):
    ...
    lang_code: str = Field(description="Wiktionary language code", examples=["ru"])
    lang: str = Field(
    ...
    hypernyms: list[Linkage] = Field(default=[], description="List of hypernyms")
    hyponyms: list[Linkage] = Field(default=[], description="List of hyponyms")
    derived: list[Linkage] = Field(default=[], description="List of derived terms")
